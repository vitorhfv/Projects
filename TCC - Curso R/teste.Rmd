...
O IMDB é uma base de dados on-line que reúne informações a respeito de grandes indústrias de entretenimento do mundo, em particular o cinema, que será nosso objeto de estudo neste trabalho. Fundado em 1990, mantém-se até hoje como fonte confiável para obtenção de informações a respeito da Sétima Arte. Vamos desbravá-lo?
